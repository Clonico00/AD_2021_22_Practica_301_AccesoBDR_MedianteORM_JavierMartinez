package Modelos;
// Generated 23-nov-2021 13:13:20 by Hibernate Tools 4.3.1
...
public class Prestamo  implements java.io.Serializable {
    ...
    public String toString() {
        return "Prestamo{" + "NPrestamo=" + NPrestamo + ", formaPago=" + formaPago + ", fecha=" + fecha + ", importe=" + importe + ", importePagado=" + importePagado + '}';
    }
